...
// Card
export WelcomeCard from './Cards/WelcomeCard';
export KWADChooseCardHire from './Cards/KWADChooseCardHire';
export VideoCard from './Cards/VideoCard';

// home page design
export KWADHeader from './KWAD/Header';
export Footer from './KWAD/Footer';
